...
Until ~tdlib-1.7.10~ makes it to ~nixpkgs~, we use the latest version compatible with ~tdlib-1.7.9~.

#+begin_src elisp :tangle packages.el
(package! telega
  :pin "acf2d99df25f15c104cd13d5bbdcb17078a353f9")
#+end_src
