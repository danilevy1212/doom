...
With the ~dtache-env~ script we get colored stdout for our dtached commands, plus other goodies.

#+begin_src emacs-lisp :tangle yes
(after! dtache
  (setq dtache-env (expand-file-name "dtache-env"
                                     (file-name-directory (locate-library "dtache")))))
#+end_src
