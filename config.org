...
Activate =annotate-mode= in file buffers.

#+begin_src emacs-lisp :tangle yes
(use-package! annotate
  :hook (find-file . annotate-mode))
#+end_src
...
(after! run-command
  (defun dan/run-command--nixos ()
    (list
     (list :command-line "rm ~/.config/mimeapps.list && sudo nixos-rebuild switch --flake '/etc/nixos#nyx15v2'"
