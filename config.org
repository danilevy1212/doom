...
#+begin_src emacs-lisp :tangle yes
(when IS-MAC
  (setq-hook! (dired-mode magit-mode)
...
Modules for keeping track of habits, completing checklists and making links to =bookmarks=, =elisp= symbols, =pdf= s, =info= pages and =man= pages.

#+begin_src lisp-data :tangle config.el
