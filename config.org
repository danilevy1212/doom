...
- WAIT :: Tasks that cannot be completed until of another task is done or and external event happens.
...
Show  =habit= styles task outside of just today.
...
(after! org-agenda
  (add-to-list 'org-agenda-custom-commands '("pd"
                                             ...
                                             agenda
                                             ""
                                             ((org-super-agenda-groups         '((:discard (:tag "work"))))
